...
# NEW 100 QUESTIONS FOR COMPREHENSIVE UAT
NEW_UAT_QUESTIONS = [
    # Basic Metrics (20 questions)
    "What is our total advertising spend?",
    "How much revenue did we generate?",
    "What's our overall return on ad spend?",
    "What is the average click-through rate?",
    "How many total impressions did we get?",
    "What's the total number of clicks?",
    "How many conversions did we achieve?",
    ...
    "What's the conversion rate across all campaigns?",
    "How much did we spend on average per campaign?",
    "What's the average revenue per campaign?",
    "How many impressions per campaign on average?",
    "What's the average number of clicks per campaign?",
    "How many conversions per campaign on average?",
    "What's our total budget utilization?",
    "What percentage of our budget went to each platform?",
    "What's the average campaign duration?",
    "How many unique campaigns do we have?",
    
    # Platform Performance (20 questions)
    "Which platform has the highest CTR?",
    "Which platform has the best ROAS?",
    "What's the average CTR for Meta?",
    "What's the average CTR for Amazon?",
    "What's the average CTR for Dv360?",
    "What's the average CTR for Cm360?",
    "What's the average CTR for Sa360?",
    "What's the average CTR for Tradedesk?",
    "What's the ROAS for Meta?",
    "What's the ROAS for Amazon?",
    "What's the ROAS for Dv360?",
    "What's the ROAS for Cm360?",
    "What's the ROAS for Sa360?",
    "What's the ROAS for Tradedesk?",
    "How much did we spend on Meta?",
    "How much did we spend on Amazon?",
    "How much did we spend on Dv360?",
    "How much did we spend on Cm360?",
    "How much did we spend on Sa360?",
    "How much did we spend on Tradedesk?",
    
    # Campaign Performance (20 questions)
    ...
    "How much did FreshNest Summer Grilling spend?",
    "How much did FreshNest Back to School spend?",
    "How much did FreshNest Holiday Recipes spend?",
    "How much did FreshNest Pantry Staples spend?",
    ...
    "What's the spend for each campaign?",
    "What's the impressions for each campaign?",
    "What's the clicks for each campaign?",
    "What's the conversions for each campaign?",
    
    # Comparative Analysis (20 questions)
    "Compare CTR performance across platforms",
    "Compare ROAS performance across platforms",
    "Compare spend allocation across platforms",
    "Compare CTR performance across campaigns",
    "Compare ROAS performance across campaigns",
    "Compare spend allocation across campaigns",
    "Which platform is most cost-effective?",
    "Which campaign is most cost-effective?",
    "What's the performance difference between Meta and Amazon?",
    "What's the performance difference between Dv360 and Cm360?",
    "What's the performance difference between Sa360 and Tradedesk?",
    ...
    "Which campaign has the lowest CPM?",
    "Which campaign has the lowest CPA?",
    "What's the efficiency ratio between spend and revenue?",
    "What's the efficiency ratio between impressions and clicks?",
    "What's the efficiency ratio between clicks and conversions?",
    
    # Advanced Analytics (20 questions)
    "Show me the top 3 performing platforms by CTR",
    "Show me the top 3 performing platforms by ROAS",
    "Show me the top 3 performing campaigns by CTR",
    "Show me the top 3 performing campaigns by ROAS",
    "What's the correlation between spend and performance?",
    "What's the correlation between impressions and CTR?",
    "What's the correlation between clicks and conversions?",
    "Which platform has the best conversion rate?",
    "Which campaign has the best conversion rate?",
    "What's the average conversion rate across all platforms?",
    "What's the average conversion rate across all campaigns?",
    "How many campaigns are performing above average?",
    "How many platforms are performing above average?",
    "What's the standard deviation of CTR across campaigns?",
    "What's the standard deviation of ROAS across campaigns?",
    "What's the standard deviation of CTR across platforms?",
    "What's the standard deviation of ROAS across platforms?",
    "Which platform has the most consistent performance?",
    "Which campaign has the most consistent performance?",
    "What's the overall campaign efficiency score?"
]

def run_new_100_question_uat():
    """Run new 100-question UAT test"""
    print("Starting NEW 100-Question UAT Test...")
    print("=" * 80)
    print(f"Testing {len(NEW_UAT_QUESTIONS)} fresh questions with comprehensive CSV validation")
    ...
    for i, question in enumerate(NEW_UAT_QUESTIONS, 1):
        print(f"Testing Question {i}/{len(NEW_UAT_QUESTIONS)}: {question}")
        ...
        if i % 10 == 0:
            print(f"\nProgress: {i}/{len(NEW_UAT_QUESTIONS)} questions completed")
            print(f"Current Score: {valid_count}/{i} ({valid_count/i*100:.1f}%)\n")
    
    # Final analysis
    print("\n" + "=" * 80)
    print("NEW 100-QUESTION UAT RESULTS")
    print("=" * 80)
    
    print(f"Total Questions Tested: {len(NEW_UAT_QUESTIONS)}")
    print(f"Valid Responses: {valid_count} ({valid_count/len(NEW_UAT_QUESTIONS)*100:.1f}%)")
    print(f"Invalid Responses: {invalid_count} ({invalid_count/len(NEW_UAT_QUESTIONS)*100:.1f}%)")
...
if __name__ == "__main__":
    results, csv_metrics = run_new_100_question_uat() 