...
# 100 Comprehensive Marketing Questions for UAT Testing
UAT_QUESTIONS = [
    # Basic Metrics (15 questions)
    ...
    "Which platform is performing worst?",
    "Which platform has the lowest CTR?",
    "Which platform has the lowest ROAS?",
    
    # Campaign Analysis (20 questions)
    ...
    "What are all the campaigns?",
    "List all campaigns",
    "Show me all campaigns",
    "What campaigns are running?",
    
    # Performance Analysis (15 questions)
...
def run_full_100_question_uat():
    """Run full 100-question UAT test through the actual UI"""
    print("Starting Full 100-Question UAT Test...")
    print("=" * 80)
    print(f"Testing {len(UAT_QUESTIONS)} questions through the actual UI")
    ...
    for i, question in enumerate(UAT_QUESTIONS, 1):
    ...
    # Final analysis
    print("\n" + "=" * 80)
    print("FULL 100-QUESTION UAT RESULTS")
    print("=" * 80)
    
    print(f"Total Questions Tested: {len(UAT_QUESTIONS)}")
    print(f"Valid Responses: {valid_count} ({valid_count/len(UAT_QUESTIONS)*100:.1f}%)")
    print(f"Invalid Responses: {invalid_count} ({invalid_count/len(UAT_QUESTIONS)*100:.1f}%)")
    
    # Show success rate by category
    print("\nSuccess Rate by Category:")
    print("-" * 40)
    categories = {
        'Basic Metrics': range(1, 16),
        'Platform Analysis': range(16, 36),
        'Campaign Analysis': range(36, 56),
        'Performance Analysis': range(56, 71),
        'Comparative Analysis': range(71, 81),
        'Specific Campaign': range(81, 91),
        'Optimization': range(91, 101)
    }
...
if __name__ == "__main__":
    results, csv_metrics = run_full_100_question_uat() 